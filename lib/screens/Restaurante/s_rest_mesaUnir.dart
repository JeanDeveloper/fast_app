...
class mesaUnir extends StatefulWidget {
  const mesaUnir({Key? key}) : super(key: key);

  @override
  _mesaUnir createState() => new _mesaUnir();
}
...
class _mesaUnir extends State<mesaUnir> with TickerProviderStateMixin {
  ...
  CargarMesas() async {
    ...
    vGlobal_Restaurante.ListaMesasNivel = vGlobal_Restaurante.ListaMesasNivel..removeWhere((element) => element.tEstado == 'BLOQUEADO');
            ...
            for (int i = 0; i < vGlobal_Restaurante.ListaMesasNivel.length; i++) ...[
              Card(
                ...
                child: CheckboxListTile(
                  ...
                  value: vGlobal_Restaurante.ListaMesasNivel[i].lUnion ?? false,
                  onChanged: (value) {
                    setState(() {
                      vGlobal_Restaurante.ListaMesasNivel[i].lUnion = value!;
                      _GenerarCargaProducto();
                    });
                  },
                ),
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              ClsTextStyle.cabeceraBienvenida(titulo: "UNIR MESAS", subtitulo: "Seleccione las mesas a unir", detalle: ''),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          ElevatedButton.icon(
            onPressed: () {
              Navigator.pushNamed(context, "navmesaUnirPrincipal");
            },
            style: ButtonStyle(
            ...
            icon: Icon(Icons.chevron_right_rounded, size: 20, color: ClsColor.tipo4()),
