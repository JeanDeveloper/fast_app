...
class mesaTransferir extends StatefulWidget {
  const mesaTransferir({Key? key}) : super(key: key);

  @override
  _mesaTransferir createState() => new _mesaTransferir();
}
...
class _mesaTransferir extends State<mesaTransferir> with TickerProviderStateMixin {
  ...
  CargarMesas() async {
    MGetMesas? ResultMesas = await getMesas;
    vGlobal_Restaurante.ListaMesasNivel = ResultMesas!.data;
    vGlobal_Restaurante.ListaMesasNivel = vGlobal_Restaurante.ListaMesasNivel..removeWhere((element) => element.tEstado != 'DISPONIBLE');
            ...
            for (int i = 0; i < vGlobal_Restaurante.ListaMesasNivel.length; i++) ...[
              Card(
                ...
                child: RadioListTile(
                  ...
                  groupValue: iMMesaDestino,
                  value: vGlobal_Restaurante.ListaMesasNivel[i].iMMesa,
                  onChanged: (value) {
                    setState(() {
                      tMesa = vGlobal_Restaurante.ListaMesasNivel[i].tMesa.toString();
                      iMMesaDestino = value!;
                      _GenerarCargaProducto();
                      print(value);
                    });
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text('¿Estas Seguro(a) de transferir la mesa?', style: TextStyle(color: ClsColor.tipo6(), fontSize: 12, fontWeight: FontWeight.w700)),
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () async {
                        Map<String, dynamic>? postReg = await postTransferirMesa(iMMesaDestino);
                        ...
                        if (codigo == "0") {
                          setState(() {
                            vGlobal_Restaurante.iMMesa = iMMesaDestino;
                            vGlobal_Restaurante.tMesa = tMesa;
                            Navigator.pop(context);
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: ClsDecoration.appBar(context, "navconsumo"),
        drawer: NavDrawer(),
        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              ClsTextStyle.cabeceraBienvenida(titulo: "TRANSFERIR MESA", subtitulo: "Seleccione mesa destino", detalle: ''),
      ...
      child: Column(
        children: [
          ...
          ElevatedButton.icon(
            ...
            icon: Icon(Icons.transfer_within_a_station_rounded, size: 20, color: ClsColor.tipo4()),
            label: Text("Transferir Mesa", style: TextStyle(color: ClsColor.tipo4(), fontSize: 16, fontWeight: FontWeight.w400)),
          ),
        ],
      ),
    );
