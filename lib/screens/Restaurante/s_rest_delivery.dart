...
class delivery extends StatefulWidget {
  ...
  @override
  _delivery createState() => new _delivery();
}
...
class _delivery extends State<delivery> with TickerProviderStateMixin {
  var result_CargaDelivery = <Widget>[];

  @override
  void initState() {
    if (this.mounted) {
      _AsyncData();
      _GenerarCargaDelivery();
      super.initState();
    }
  }
  ...
  void _GenerarCargaDelivery() {
    setState(() {
      result_CargaDelivery = <Widget>[];
      result_CargaDelivery.add(
        FutureBuilder<GetParaLlevarDelivery?>(
          future: getParaLlevarDelivery(3),
          builder: (context, snapshot) {
            ...
            return GridView.builder(
              ...
              itemBuilder: (context, index) {
                return ClsDecoration.listMesasDelivery(lista: Lista, index: index, context: context);
              },
            );
          },
        ),
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              ClsTextStyle.cabeceraBienvenida(titulo: "", subtitulo: "", detalle: '', vistaIconos: ""),
        ...
        children: [
          ...
          Expanded(
            child: SingleChildScrollView(
              child: Stack(children: result_CargaDelivery),
            ),
          ),
          const SizedBox(height: 10),
          ElevatedButton.icon(
